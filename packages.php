<section class="page-section bg-dark" id="home">
	<div class="container">
		<h2 style=" padding-top: 10px;" class="text-center"> PACOTES TURISTICOS </h2>
	<div class="d-flex w-100 justify-content-center">
		<hr class="border-dark" style="border:3px solid" width="15%">
	</div>
	<div class="w-100">
		<?php
		...
		?>
			<div class="card d-flex w-100 rounded-0 mb-3 package-item">
				...
				<div class="w-100 d-flex justify-content-between">
					<span style="font-weight: bolder;" class="rounded-0 btn btn-flat btn-sm btn-secondary"><i class=""></i> <?php echo number_format($row['cost']) ?></span>
					<a href="./?page=view_package&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-secondary" style="font-weight: bolder;">VISUALIZAR<i class=""></i></a>
				</div>
				</div>
			</div>
		<?php endwhile; ?>
