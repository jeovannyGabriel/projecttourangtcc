...
<div class="container-fluid ">
    ...
    <div class="row">
        <div class="col-lg-5 border-right">
            <h3 class="text-center bg-dark" > ENTRAR</h3>
            <hr>
            <form action="" id="login-form">
                <div class="form-group">
                    <label for="" class="control-label">NOME DE USUÁRIO</label>
                ...
                <div class="form-group d-flex justify-content-end">
                    <button style="font-weight: bolder;" class="btn btn-secondary align-center btn-flat">ENTRAR</button>
                </div>
            </form>
        </div>
        <div class="col-lg-7">
        <h3 class="text-center bg-dark">NÃO TEM UMA CONTA?</h3>
        <hr class=''>
            <form action="" id="registration">
                ...
                <div class="form-group d-flex justify-content-end">
                    <button style="font-weight: bolder;" class="btn btn-secondary  btn-flat">CRIAR CONTA</button>
                </div>
            </form>
        </div>
    </div>
